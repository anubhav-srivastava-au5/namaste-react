...
const Register = () => (
  <div className='bg-purple-200 shadow-2xl  p-2 m-2'>
   <div className='flex flex-wrap p-2 m-2 mb-4 justify-center'>
    ...
    <Link to="/login"><h4 className='text-lg text-orange-500'>or login to your account</h4></Link>
    </div>
    <div>
    <img alt='register-page-img' className='w-36 h-36 ml-20' src='https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/Image-login_btpq7r' />
    </div>
    </div>
