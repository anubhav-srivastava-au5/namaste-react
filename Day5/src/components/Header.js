...
//     let [searchKeyword,setSearchKeyword]=useState("KFC");

//     return (
//         <>
//         <input type="text" placeholder="Search for restaurents and foods" value={searchKeyword} style={{ display: 'table', margin: 'auto', width: '50%', height: '27px' }} />
